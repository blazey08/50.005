    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                deCipher.init(Cipher.DECRYPT_MODE, publicServerKey);
                ...
                if (inSplit[0].equals("exit")) {
                    ...
                    if(fileToSend != null){
                        try {
                            fileIO.sendEncryptedFile(toServer, fileToSend, publicServerKey);
                    ...
                    if (fileToDL != null) {
                        ...
                        if (isExist == 0) {
                            ...
                            fileIO.receiveEncryptedFile(fromServer, publicServerKey);
